...
namespace OOAD_G6_najjaci_tim.Controllers
{
    public class SalasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Kapacitet,brojSale,Je4D")] Sala sala)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Kapacitet,brojSale,Je4D")] Sala sala)
        {
            if (id != sala.Id)
            {
                return NotFound();
